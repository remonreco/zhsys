...
<body>
	...
	<input type="hidden" id="allSysBusiRolesUrl" value='<c:url value="/SysBusiRolesLevel.html"/>' />
	...
	<div id="upateUserDiv" class="easyui-dialog" style="width: 420px; height: 380px; padding: 10px 20px" closed="true" buttons="#upateUserDiv-buttons">
		<form id="updateUserFm" method="post" novalidate>
			...
			<div class="fitem">
				<label class="fitemlabel">确认密码:</label> <input class="easyui-validatebox" type="password" id="loginPwd2_2"  name="loginPwd2" validType="equals['#loginPwd2']"></input>
			</div>
			<div class="fitem">
				<label class="fitemlabel">角色:</label> <span id="rolespan2"></span>
			</div>
			<div class="fitem">
				<label class="fitemlabel">手机号:</label> <input class="easyui-validatebox" type="text" name="tel" data-options="required:false" validType='mobile'></input>
			</div>
			<div class="fitem">
