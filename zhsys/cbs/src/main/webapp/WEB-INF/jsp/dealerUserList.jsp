...
<script type="text/javascript" src='<c:url value="/js/pages/dealerUser.js"/>'></script>
<style type="text/css">
#fm {
	margin: 0;
	padding: 10px 30px;
...
<body>
	<input type="hidden" id="addDealerUserUrl" value='<c:url value="/addDealerUser.html"/>' />
	<input type="hidden" id="editDealerUserUrl" value='<c:url value="/editDealerUser.html"/>' />
	...
	<input type="hidden"  id="agencyId"  name ="agencyId" value ="${agencyId}">
	   <div id="userbar" style="padding:5px;height:auto" align="left">
       <form id="dealerfm" action="" method="post">
 		...
 		<!-- 权益帐号<input class="easyui-validatebox" type="text" name="rightsAccount" id="rightsAccount" style="width:130px">&nbsp; <br>-->
 		会员姓名<input class="easyui-validatebox" type="text" name="userName" id="userName" style="width:100px">&nbsp;
 		联系电话<input class="easyui-validatebox" type="text" name="tel" id="tel" style="width:100px">&nbsp;
			<br>
		 		<a class="easyui-linkbutton" onclick="selectDealerUser()">查询</a>&nbsp;&nbsp;
		 		<a href="javascript:void(0)" class="easyui-linkbutton" onclick="addDealerUser()">添加</a>&nbsp;&nbsp;
		 		<a href="javascript:void(0)" class="easyui-linkbutton" onclick="toUpdateDealerUser()">编辑</a>&nbsp;&nbsp;
 	    </form>
 	</div>
 	
 	<table id="dealerUserList" border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
		<thead>
			<tr align="center">
			</tr>
		</thead>
	...
	<!-- 添加会员 -->
	<div id="addDealerUserDiv" class="easyui-dialog" style="width: 400px; height: 380px; padding: 10px 20px" closed="true" buttons="#addDealerUserDiv-buttons">
		<form id="addDealerUserFm" method="post" novalidate>
			<div class="fitem">
			...
			<div class="fitem">
				<label class="fitemlabel">联系方式:</label> <input class="easyui-validatebox" type="text" id="tel2" name="tel2" data-options="required:true" validType='mobile'></input>
			</div>
			<div class="fitem">
	...
	<div id="addDealerUserDiv-buttons">
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="saveDealerUser()">保存</a> <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
			onclick="javascript:$('#addDealerUserDiv').dialog('close')">取消</a>
	</div>
	<!-- 编辑会员 -->
	<div id="editDealerUserDiv" class="easyui-dialog" style="width: 400px; height: 380px; padding: 10px 20px" closed="true" buttons="#editDealerUserDiv-buttons">
		<form id="editDealerUserFm" method="post" novalidate>
			...
			<div class="fitem">
				<label class="fitemlabel">联系方式:</label> <input class="easyui-validatebox" type="text" id="tel3" name="tel3" data-options="required:true" validType='mobile'></input>
			</div>
			<div class="fitem">
	...
	<div id="editDealerUserDiv-buttons">
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="editDealerUser()">保存</a> <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
			onclick="javascript:$('#editDealerUserDiv').dialog('close')">取消</a>
	</div>
</body>
</html>