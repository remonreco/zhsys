...
<body>
	...
	<div class="bq-paysucess">
		<div class="bq-paysucess-top">
			<p>
				<span>线上认购登记系统 > </span><span> &nbsp;支付 ></span><span>&nbsp;支付成功
				</span>
			</p>
		</div>
		<div class="bq-paysucess-cont clear">
			...
			<div class="bq-paysucess-contright">
				<div class="bq-pysuc-cotri-top">
					<h4>订单详情</h4>
					<p>
						<strong>订单号：</strong><em style="margin-right: 20px;">${record.orderSerial}</em><strong>订单状态：</strong><em>已付款</em>
					</p>
					<p>
						<strong>下单时间：</strong><em>${record.sendDate}</em>
					</p>
					<p style="border-bottom: 1px solid #e7e6e6; line-height: 46px;">
						<strong>下单时间：</strong><em>网上支付</em>
					</p>
					<h4>商品清单</h4>
					<p>
