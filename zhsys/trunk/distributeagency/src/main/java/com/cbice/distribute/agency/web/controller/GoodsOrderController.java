...
public class GoodsOrderController extends BaseController {
	...
	public void setvGoodsOrderUserService(VGoodsOrderUserService vGoodsOrderUserService) {
	...
	public @ResponseBody
	Map<String, Object> querySysRoles(String page, String rows, VGoodOrderUser good) {
	...
	@Transactional
	public @ResponseBody
	int agreeOrder(String ids, String reason) {
		int result = 0;
	...
	@Transactional
	public @ResponseBody
	int disAgreeOrder(String ids, String reason) {
		int result = 0;
		String[] idList = ids.split(",");
		try {
			reason = java.net.URLDecoder.decode(reason, "UTF-8");
