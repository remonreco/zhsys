...
<body>
	...
	<div id="updateRoleDiv" class="easyui-dialog" style="width: 420px; height: 380px; padding: 10px 20px" closed="true" buttons="#upateRoleDiv-buttons">
		<form id="updateRoleFm" method="post" novalidate>
			<div class="fitem">
				<label class="fitemlabel">角色名:</label> <span id="updateRoleId"></span> <input class="easyui-validatebox" type="text" id="name2" name="name" data-options="required:true" validType="name1"></input>
			</div>
			<div class="fitem">
