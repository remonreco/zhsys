...
<body>
 		...
 		产品名称<input class="easyui-validatebox" type="text" name="goodsName3" id="goodsName3" style="width:130px">&nbsp;
			<br>
                ...
                <a href="#" class="easyui-linkbutton" onclick="toUpdateUser()">修改</a>
 				<a href="#" class="easyui-linkbutton" onclick="toSendGoods()">分发产品</a>
 	    </form>
 	</div>
	...
	<div id="addgoodsDiv" class="easyui-dialog" style="width: 400px; height: 380px; padding: 10px 20px" closed="true" buttons="#addgoodsDiv-buttons">
		<form id="addgoodsFm" method="post" novalidate>
			...
			<div class="fitem">
				<label class="fitemlabel">产品名称:</label> <input class="easyui-validatebox" type="text" id="goodsName2" name="goodsName2" data-options="required:true" validType="length[0,64]"></input>
			</div>
			<div class="fitem">
				<label class="fitemlabel">产品单价:</label> <input class="easyui-validatebox" type="text" id="goodsPrice2" name="goodsPrice2" data-options="required:true" validType="numberM"></input>
			</div>
			<div class="fitem">
				<label class="fitemlabel">发货数量:</label> <input class="easyui-validatebox" type="text" id="goodsCount2" name="goodsCount2" data-options="required:true" validType="numberV"></input>
			</div>
		</form>
	</div>
	...
	<!-- 修改产品 -->
		...
		<form id="updategoodsFm" method="post" novalidate>
		   <input type="hidden" name="id" id="id">
			<div class="fitem">
				<label class="fitemlabel">产品编号:</label> <input class="easyui-validatebox" type="text" id="goodsNum" name="goodsNum" data-options="required:true" validType="length[0,64]"></input>
			</div>
			<div class="fitem">
				<label class="fitemlabel">产品名称:</label> <input class="easyui-validatebox" type="text" id="goodsName" name="goodsName" data-options="required:true" validType="length[0,64]"></input>
			</div>
			<div class="fitem">
				<label class="fitemlabel">产品单价:</label> <input class="easyui-validatebox" type="text" id="goodsPrice" name="goodsPrice" data-options="required:true" validType="numberM"></input>
			</div>
						<div class="fitem">
				<label class="fitemlabel">发货数量:</label> <input class="easyui-validatebox" type="text" id="goodsCount" name="goodsCount" data-options="required:true" validType="numberV"></input>
			</div>
		</form>
	</div>
	<div id="updategoodsDiv-buttons">
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="updategoods()">更新</a> <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
