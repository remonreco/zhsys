...
public class TrancationReportController extends BaseController {
	...
	public @ResponseBody Map<String, Object> queryTuser(String page,
		...
		map.put("tUserId", constantList.IceId);//ICE会员ID
...
//		}
//		String userid="";
//		if(com.cbice.distribute.core.util.StringUtils.isNotEmpty(userId)){
//			userid=userId.substring(0, userId.indexOf(","));
//		}
		/*TUser user=userService.selectById(Long.parseLong(userId));//查询会员信息
		long agencyid=user.getAgencyId();//获取所属经销商ID
*/		
		TAgency agency=tAgencyService.selectByAgencyId(Long.parseLong(userId));
		
		Map<String,Object> map=new HashMap<String,Object>();
		map.put("agenylft", agency.getLft());
		map.put("agenyrgt", agency.getRgt());
