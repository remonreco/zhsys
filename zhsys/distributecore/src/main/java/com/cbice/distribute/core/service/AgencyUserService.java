...
public interface AgencyUserService {
	 ...
	 * @return 用户信息
	 */
	TUser selectAgencyUserByLoginName(String loginName);
	 ...
	 * @return 1 存在 0 不存在
	 */
	String checkDuplicateAgencyUserLoginName(String loginName);
	 ...
	 */
	@Transactional
	int insertUser(TUser tAgencyUser, Long[] busiRolesIds)
			throws PayPluginException;
	 ...
	 */
	@Transactional
	Map<String,String> updateUser(TUser tAgencyUser, Long[] roles,long level) throws PayPluginException;

	int updateByPrimaryKeySelective(TUser tAgencyUser);
}
