...
<style>
	.bq-paysucess-cont{margin:0 auto;}
	.bq-accountActive-content{margin-left:0; padding-top:50px; text-align:center;}
	.bq-accountActive-content span{display:block; margin-bottom:30px; margin-left:0;}
	.bq-accountActive-content b{display:block; margin-bottom:50px; color:red;}
</style>
</head>
<body>
	<div class="bq-logo">
	...
	<div class="bq-paysucess-top1">
		<p>
			<span>线上兑换系统 > </span><span> &nbsp;账号激活 > </span><span> &nbsp;确认密码 > </span><span> &nbsp;失败 > </span>
	...
	<div class="bq-paysucess-cont clear">
		<div class="bq-accountActive-content">
			<span>
				<img src="images/flied.jpg" />
		<c:if test="${not empty sessionScope.activError}">
			<span style="color:red;text-align: center; padding: 5px">
			</span>
			<b>${sessionScope.activError}</b>
		</c:if> 
