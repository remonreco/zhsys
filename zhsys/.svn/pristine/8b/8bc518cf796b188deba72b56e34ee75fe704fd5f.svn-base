 ...
 */
@Controller
public class CommodityApprovalControllerI extends BaseController{
	private Logger logger = LoggerFactory.getLogger(this.getClass());
	@Resource
	TCommodityApprovalService tCommodityApprovalService;
	@Resource
	TtransactionRecordService ttransactionRecordService;

	/**
	 * 跳转至商品审核列表页面
	 * @return
	 */
	@RequestMapping("/commodityApprovalI")
	 ...
	 * @return
	 */
	@RequestMapping("/queryCommodityApprovalFirstI")
	public Map<String, Object> toCommodityApproval() {
		...
		maps.put("list", list);
		jsonMap.put("msg", "跳转审核列表页面，不显示数据");
		jsonMap.put("value", "1");
	 ...
	 * @return
	 */
	@RequestMapping(value="/queryCommodityApprovalI",method=RequestMethod.POST)
	@ResponseBody
	public  Map<String, Object> queryCommodity(HttpServletResponse response,String page,
			String rows, String customerName, String exchangeName, String approvalTimeStart, String approvalTimeEnd,String approvalresult,String sysId) {
...
//		response.setContentType("text/html;charset=utf-8");
		...
		map.put("customerName", customerName);// 序列号
		map.put("exchangeName", exchangeName);// 产品编号
		map.put("sysId", sysId);// 系统编号
	 ...
	 * @return
	 */
	@RequestMapping("/doCommodityApprovalI")
	public @ResponseBody Map<String, Object> doCommodityApproval(HttpServletRequest request) {
		int result = 0;
		Map<String, Object> map = new HashMap<String, Object>();
		Map<String, Object> maps = new HashMap<String, Object>();
		Map<String, Object> jsonMap = new HashMap<String, Object>();
...
//		map.put("orderTimeEnd",DateUtils.getAnyDayByNo(orderTimeStart, 1));
		try {
			...
			jsonMap.put("msg", "商品审批失败");
			jsonMap.put("value", "0");
			jsonMap.put("data", maps);
			jsonMap.put("rows", 0);
			return jsonMap;
		}
		jsonMap.put("msg", "商品审批成功");
		jsonMap.put("value", "1");
		jsonMap.put("data", maps);
		jsonMap.put("rows", 0);
		return jsonMap;
	 ...
	 * @return
	 */
	@RequestMapping("/downLoadApprovalSuccessI")
	@ResponseBody
	public Object downLoadApprovalSuccess(HttpServletRequest request,HttpServletResponse response) {
		response.setContentType("text/html;charset=utf-8");
		Map<String, Object> map = new HashMap<String, Object>();
		Date approvalTime = DateUtils.StringToDate((DateUtils.DateToString(new Date(), "yyyy-MM-dd")), "yyyy-MM-dd");
		String sysId=request.getParameter("sysId");
		...
		String fileName = "今日审批" + nowTime + ".xls";
...
//							}
	 ...
	 * @return
	 */
	@RequestMapping("/downLoadApprovalSuccessExI")
	@ResponseBody
	public Object downLoadApprovalSuccessEx(HttpServletRequest request,HttpServletResponse response) {
		response.setContentType("text/html;charset=utf-8");
		Map<String, Object> map = new HashMap<String, Object>();
		Date approvalTime = DateUtils.StringToDate((DateUtils.DateToString(new Date(), "yyyy-MM-dd")), "yyyy-MM-dd");
		String sysId=request.getParameter("sysId");
...
//							}
	 ...
	 * @return
	 */
	@RequestMapping("/doTransactionRecordApprovalI")
	public @ResponseBody Map<String, Object> doTransactionRecordApproval(HttpServletRequest request,String sysId,String startTime,String endTime) {
		Map<String, Object> jsonMap = new HashMap<String, Object>();
		Map<String, Object> maps = new HashMap<String, Object>();
		try {
			maps.put("sysId", sysId);
			maps.put("startTime", DateUtils.StringToDate(startTime, "yyyy-MM-dd HH:mm:ss"));
			maps.put("endTime", DateUtils.StringToDate(endTime, "yyyy-MM-dd HH:mm:ss"));
			int result = ttransactionRecordService.doTransactionRecordApproval(maps);
			maps = new HashMap<String, Object>();
			if(result!=1){
				jsonMap.put("msg", "交易记录插入用户权益表出错！");
				jsonMap.put("value", "0");
				jsonMap.put("data", new HashMap<String, Object>());
				jsonMap.put("rows", 0);
				return jsonMap;
			}
			jsonMap.put("msg", "交易记录处理成功！");
			jsonMap.put("value", "1");
			jsonMap.put("data", maps);
			jsonMap.put("rows", 0);
		} catch (Exception e) {
			maps = new HashMap<String, Object>();
			jsonMap.put("msg", "交易记录处理失败！");
			jsonMap.put("value", "0");
			jsonMap.put("data", maps);
			jsonMap.put("rows", 0);
			return jsonMap;
