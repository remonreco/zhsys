...
<body>
	<!-- <input type="hidden" id="checkTAgencyBydealerNumAndName" value='<c:url value="/checkAccessByaccountAnddeveloper.html"/>' /> -->
       ...
       <form id="accessGoldfm" action="" method="post">
 		经销商代码<input class="easyui-validatebox" type="text" name="developer" id="developer" style="width:130px">&nbsp;
 		客户账号<input class="easyui-validatebox" type="text" name="clientId" id="clientId" style="width:130px">&nbsp;
